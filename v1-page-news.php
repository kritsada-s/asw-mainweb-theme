...
<div class="cont-pd py-6 flex flex-row items-center">
    ...
    <a href="/<?=pll_current_language()?>/news-archive" class="">ข่าวสาร</a>
</div>

<section id="club-news" class="pt-6 md:pt-9 pb-12 md:pb-14">
    <img src="<?= ASW_MEDIA_PATH ?>/2022/12/Group-793-1.png" class="absolute pointer-events-none leaf15">
    <img src="<?= ASW_MEDIA_PATH ?>/2022/12/shutterstock_1574382076-1-2.png" class="absolute pointer-events-none leaf16">
    <div class="cont-pd">
        <h1>ข่าวสาร</h1>
        <sp class="l"></sp>
                            ...
                            <div class="h-full flex flex-col" > 
                                <div class="h-full flex flex-col-reverse justify-between" style="display: flex;">
                                    ...
                                    <div>
                                        ...
                                        <sp class=""></sp>
                                        <sp class="s <?php if($chk % 2 == 1){echo 'bg-ci-veri-500';}else{echo 'bg-orange';} ?>" style="width: 15%; height: 4px;"></sp>
                                        <sp class=""></sp>
                                    </div>
                                </div>
                        ...
                        <div class="-flex flex-col justify-between bg-ci-grey-900 h-full p-4 py-6 relative pointer" onclick="location.href='<?= get_permalink()?>'">
                            <div class="h-full flex flex-col" > 
                                <div class="h-full flex flex-col-reverse justify-end" style="display: flex;">
                                    <div>
                                       <?php if($chk != 1){echo '<sp class="l"></sp>';} ?>
                                       <h5 id="txt_title"><?= get_the_title() ?></h5>
                                       <sp class=""></sp>
                                       <span id="txt_title" class="cl-ci-grey-300">
                                        <?= the_excerpt() ?>
