...
<section id="banner" class="asw360-dev">
	<div class="">
		<img src="<?= get_field('banner')['url']; ?>" class="w-full desktop-only">
		<img src="<?= get_field('banner_mobile')['url']; ?>" class="w-full mobile-only">
	</div>
</section>
				...
				<section id="club-menu" class="col-span-3 lg:pl-6 lg:pb-10 pt-4">
					<div class="">
						<div id="club-menu-left">
							...
							<sp class="l"></sp>
							<div id="menu" class="flex justify-between md:justify-start gap-2 md:gap-4 flex-col lg:gap-0 side-nav-menu relative pb-2.5 lg:pb-0"
							style="">
...
<div class="lg:col-span-9 -overflow-auto -scroll-hid">
	...
	<div id="club-blog" class="py-6 club-wrap">
		<h2 class="hidden lg:block"><?php pll_e('ทั้งหมด')?></h2>
		<sp class="l hidden lg:block"></sp>
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
			<?php
	...
	<div id="club-news" class="py-6 club-wrap">
		<h2 class="hidden lg:block"><?php pll_e('ทั้งหมด')?></h2>
		<sp class="l hidden lg:block"></sp>
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
			<?php
	...
	<div id="club-activity" class="py-6 club-wrap">
		<h2 class="hidden lg:block"><?php pll_e('ทั้งหมด')?></h2>
		<sp class="l hidden lg:block"></sp>
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
			<?php
	...
	<div id="club-fgf" class="py-6 club-wrap">
		<h2 class="hidden lg:block"><?php pll_e('FRIEND GET FRIEND')?></h2>
		<sp class="l hidden lg:block"></sp>
		<form action="">
			<h3><?php pll_e('ข้อมูลผู้แนะนำ'); ?></h3>
			<div id="referrer_form" class="w-3/5">
				<div class="flex flex-col gap-2">
					<div class="input-group">
						<label for="fname"><?php pll_e('ชื่อ-นามสกุล'); ?></label>
						<input type="text" id="fname" name="fname" class="rounded">
					</div>
					<div class="input-group">
						<label for="addr"><?php pll_e('ที่อยู่ที่ติดต่อได้'); ?></label>
						<input type="text" id="addr" name="addr" class="rounded">
					</div>
					<div class="input-group">
						<label for="tel"><?php pll_e('เบอร์โทรศัพท์'); ?></label>
						<input type="tel" id="tel" name="tel" class="rounded">
					</div>
					<div class="input-group">
						<label for="email"><?php pll_e('อีเมล'); ?></label>
						<input type="email" id="email" name="email" class="rounded">
					</div>
				</div>
			</div>
			<div class="h-10"></div>
			<h3><?php pll_e('ข้อมูลผู้ถูกแนะนำ'); ?></h3>
			<div id="referee_form" class="w-3/5">
				<div class="flex flex-col gap-2">
					<div class="input-group">
						<label for="fname"><?php pll_e('ชื่อ-นามสกุล'); ?></label>
						<input type="text" id="fname" name="fname" class="rounded">
					...
					<div class="input-group">
						<label for="interest_project"><?php pll_e('โครงการที่สนใจ'); ?></label>
						<input type="text" id="interest_project" name="interest_project" class="rounded">
					</div>
					<div class="input-group">
						<label for="email"><?php pll_e('อีเมล'); ?></label>
						<input type="email" id="email" name="email" class="rounded">
			...
			<button id="submit" type="submit" class="rounded bg-blue-600 text-2xl text-white px-5 py-2 w-fit mt-3">
				<?php pll_e('ส่งข้อมูล'); ?>
			</button>
		</form>
	</div>

	<div id="club-privilege" class="py-6 club-wrap">
		<h2 class="hidden lg:block"><?php pll_e('ทั้งหมด')?></h2>
		<sp class="l hidden lg:block"></sp>
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
			<?php
	...
	<div id="club-grow-together" class="py-6 club-wrap">
		<h2 class="hidden lg:block"><?php pll_e('ทั้งหมด')?></h2>
		<sp class="l hidden lg:block"></sp>
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
			<?php
