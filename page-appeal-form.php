        ...
        <div id="contact-form" class="lg:col-span-6 lg:mx-8 pt-8 md:pt-0 xl:pt-4">
            <div class="-wrap">
                <div class="-title-wrap">
                    <h2 class="-title"><?php pll_e('ร้องเรียนธรรมาภิบาล')?></h2>
                    ...
                    <div class="-annouce">
                        <img src="<?= ASW_MEDIA_PATH ?>/2023/03/material-symbols_lock.png" alt="">
                ...
                <div class="-body">
                    ...
                    <div class="-checkbox">
                        <label onchange="check_appeal()">
                            <input type="checkbox" id="form_check_ok">
                            <span> <?php pll_e('บริษัทฯ จะจัดเก็บข้อมูลของท่าน
                            เพื่อเจ้าหน้าที่ของเราจะรับเรื่องและติดต่อกลับ
                            โดยเร็วที่สุดคลิกที่นี่เพื่อดู')?>
                    ...
                    <div class="-button" onclick="send_appeal()">
                        <?php pll_e('ส่งแบบฟอร์ม')?>
                    </div>
                </div>
                <script>
                    function send_appeal() {
                        ...
                        $('#asw_appeal-submit').click()
                    }

                    function check_appeal() {
                        $('#asw_appeal-check input').click()
                    }
                </script>
            </div>
        </div>
