...
<section id="home-slider">
	...
	<script type="text/javascript">
		...
		let autoPlay = 1;
		if (document.querySelector('#home-slider-inner #home-slider-count .-num-min') != null) {
		...
		function changeSlider(plus){
			if (document.querySelector('#home-slider-inner #home-slider-count .-num-bar div') != null) {
...
<!-- 	<div id="bg-circle" class="absolute">
		<img src="<?= ASW_MEDIA_PATH ?>/2022/12/circle.png">
	</div> -->
	<div class="cont-pd  pt-2 xl:pt-10 -pb-10">
		...
		<div class="grid grid-flow-row lg:grid-cols-12 gap-4">
				...
				<div class="cont-pd">
					<div class="flex flex-col justify-center">
						<div class="flex flex-row justify-center items-center">
							<img src="<?= ASW_MEDIA_PATH ?>/2022/11/unnamed-file.png" class="relative m-0 mr-4" style="top:-17px;">
							<div class="f40-30"><?php echo $f['first_quote'] ?></div>  
							<img src="<?= ASW_MEDIA_PATH ?>/2022/11/1.png" class="relative m-0 ml-4" style="bottom:-12.5px;">
						</div>
						<sp class="l"></sp>
						...
						<sp class="vl"></sp>
						<div class="">
							<iframe width="800" height="430" src="<?=$f['video']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						<sp style="height: 90px;"></sp>
						<div class="flex flex-row justify-center items-center">
							<img src="<?= ASW_MEDIA_PATH ?>/2022/11/unnamed-file.png" class="relative m-0 mr-4" style="top:-40px;">
							<div class="text-center f40-30">
								<?php echo $f['second_quote'] ?>
							</div>
							<img src="<?= ASW_MEDIA_PATH ?>/2022/11/1.png" class="relative m-0 ml-4" style="bottom:-40px;">
						</div>
						...
						<div class="about-fung relative">
							...
							foreach ($v['fearture_link'] as $key => $value){ 
								if ($key % 2 == 0) { ?>
									<div class="grid grid-flow-row md:grid-cols-12 about-mini-section" data-play="1" data-show="0">
										<div class="col-span-7 grid grid-cols-12 md:flex flex-row gap-3 md:mr-9">
											<div class="gap-2 md:gap-6 flex flex-col h-4/5 md:h-auto">
												<div class="f40-36 cl-ci-blue-300" style="transform: rotate(-90deg);">
													<?php
													echo sprintf("%02d", $key+1);
													?>
												</div>
												<!-- <img src="<?= ASW_MEDIA_PATH ?>/2022/12/Group-1088-1.png" class="about-line"> -->
											...
											<div class="col-span-11 bg-cover blank" ratio="16:9" style="background-image: url('<?= $value['image']['url'] ?>');"></div>
										</div>
										<div class="col-span-5">
											<div class="pt-8">
												<div class="f40-30"><?= $value['title'] ?></div>
								...
								<?php }
									...
									<div class="grid grid-flow-row md:grid-cols-12 about-mini-section" data-play="1" data-show="0">
										...
										<div class="row-start-3 md:row-start-1 md:col-start-2 md:col-span-5 lg:col-start-3 lg:col-span-5 ">
											<div class="pt-8 text-left md:text-right">
												<div class="f40-30"><?= $value['title'] ?></div>
												<sp style="height: 28px;" ></sp>
												<span style="font-size: 22px;line-height: 28px;" class="cl-ci-grey-300"><?= $value['description'] ?></span>
											</div>
										</div>
										<div class="md:col-start-7 md:col-span-6 lg:col-start-8 lg:col-span-5 flex flex-row gap-3 md:ml-9">
											<div class="bg-cover blank" style="background-image: url('<?= $value['image']['url'] ?>');width: 100%; height: 100%; aspect-ratio: 1/1;"></div>
											<div class="gap-6 flex flex-col">
												...
												<!-- <img src="<?= ASW_MEDIA_PATH ?>/2022/12/Group-1088-2.png" class="about-line"> -->
						...
						<div class="flex justify-center items-center relative px-9 md:px-48">
							<h3 class="text-center relative">
								<img src="<?= ASW_MEDIA_PATH ?>/2022/11/unnamed-file.png" class="absolute m-0 mr-4" style="top:-10px;left: -30px;">
								<?= $v['quote'] ?>
								<img src="<?= ASW_MEDIA_PATH ?>/2022/11/1.png" class="absolute m-0 ml-4" style="bottom:-5px;right: -30px;">
							</h3>
						</div>
						<sp class="rem-6"></sp>
						...
						<sp class="rem-5"></sp>
						<!-- <sp class="l"></sp> -->
						<h2 class="text-center f40-30"><?php pll_e('จรรยาบรรณธุรกิจ (Code of Conduct)') ?> </h2>
						<sp class="vl"></sp>
						<div class="md:px-20">
			...
			<div id="Modal-img" class="modal-img scroll-hid">
				...
				<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-l.png" class="absolute pointer hidden md:block arrow-l" onclick="plusSlides(-1)">
				<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="absolute pointer hidden md:block arrow-r" onclick="plusSlides(1)">
			</div>
		</div>
	</div>
</section>
