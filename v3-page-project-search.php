...
<section id="project-search-nav" class="bg-ci-grey-900 relative">
	...
	<div class="cont-pd py-4 flex flex-row items-center">
		...
		<a href="/project-search" class=""><?php pll_e('ค้นหาโครงการ')?></a>
	</div>
			...
			<div class="cont-pd">
				<div class="">
					<theboxes class="middle center t-center- -clip round" style="margin-top: 0px;z-index: 10;border-radius: 8px;" boxing="5">
								...
								<span class="wide">
									<div class="grid grid-cols-5">
										<div class="col-span-1 flex items-center">
											<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input.png" class="inline-block" style="height:1.5rem">
										</div>
						...
						<box col=""><inner id="filter_1" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(1, this)">
							<div class="quick-filter-inner">
								<span class="wide">
									<div class="grid grid-cols-5">
										<div class="col-span-1 flex items-center">
											<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-1.png" class="inline-block" style="height:1.5rem">
										</div>
										<div class="col-span-4">
						...
						<box col=""><inner id="filter_2" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(2, this)">
							<div class="quick-filter-inner">
								<span class="wide">
									<div class="grid grid-cols-5">
										<div class="col-span-1 flex items-center">
											<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-2.png" class="inline-block" style="height:1.5rem">
										</div>
										<div class="col-span-4">
						...
						<box col=""><inner id="filter_3" class="padding quick-filter v-middle-wrap cursor-pointer" onclick="filter_pop_price(this)" data-open="-1" data-price-min="0" data-price-max="">
							<div class="quick-filter-inner">
								<span class="wide">
									<div class="grid grid-cols-5">
										<div class="col-span-1 flex items-center">
											<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-3.png" class="inline-block" style="height:1.5rem">
										</div>
										<div class="col-span-4">
						...
						<box col=""><inner id="filter_4" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(0, this)">
							<div class="quick-filter-inner">
								<span class="wide">
									<div class="grid grid-cols-5">
										<div class="col-span-1 flex items-center">
											<img src="<?= ASW_MEDIA_PATH ?>/2022/11/Group-908.png" style="height:1.5rem">
										</div>
										<div class="col-span-4">
...
<div class="mini-filter-popup">
	...
	<div class="popup-filter-inner" onclick="filter_pop_mini(0)">
		<div class="grid grid-cols-12">
			<div class="col-span-1 flex items-center">
				<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input.png" class="inline-block" style="height:2rem;margin:0;">
			</div>
	...
	<div class="bg-white pl-5">
		...
		foreach ($price as $key => $value) {
			...
			<div class="flex inline popup-filter-price -mini p-2 pointer justify-between pr-0" num="3" onclick="check_chk(this, 3);">
				<label class="pointer" for="type_condo" price="<?=$value['price']?>" name="ไม่เกิน <?=$value['price']?> ล้านบาท"><?php pll_e('ไม่เกิน')?> <?=$value['price']?> <?php pll_e('ล้านบาท')?></label>
				<div class="ratio-box">
	...
	<div class="cont-pd">
		...
		<div class="grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 flex items-center">
			<div class="row-span-1 md:col-span-1">
				<h5 class="f30-28 cl-ci-grey-100"><span id="tit-con"><?php pll_e('โครงการแนะนำจากแอสเซทไวส์')?> </span><span id="num-con" class="cl-ci-grey-400">- <?=$count_num?> <?php pll_e('รายการ')?></span></h5>
			</div>
			<div class="row-span-1 md:col-span-1 flex justify-end">
				<div  id="sortby-box-wrap" class="box-fil-date pointer relative" data-sortby="-1" data-sorttype="date" onclick="turnon_sorting()">
					<span class="sortby-box" data-sortby="-1" data-sorttype="date"><?php pll_e('เรียงลำดับโครงการ')?>
					</span>
