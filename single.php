				...
				<section id="related-project" class="py-6 lg:py-16" data-relatecount="<?=$relate_count?>">
					<div>
						<div class="absolute w-full top-1/2 related-project-arrow">
							<div class=" cont-pd">
								<img id="home-pro-arrow-1" src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-l.png" class="absolute pointer  " onclick="singleProjectArrow(-1)" style="opacity: 0; z-index: -1;">
								<img id="home-pro-arrow-2" src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="absolute pointer  " onclick="singleProjectArrow(1)" style="z-index: 9; top: 51%; opacity: 1;">
							</div>
						</div>
							...
							<div class="t-center relative-wrap">
								<div class="grid grid-cols-12">
									...
									<h5 class="col-span-3 text-right">
										<a href="/project-search/" class="see-more"><?php pll_e('ดูทั้งหมด')?><img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="m-0 pl-2 inline-block" style="width: auto; height: 35px;">
										</a>
									</h5>
														...
														<div class="bottom-left">
															<div class="flex flex-row items-center" style="line-height: 28px;">
																<?php if ($cate_parent->slug == 'condominium') { ?>
																	<img src="<?= ASW_MEDIA_PATH ?>/2022/09/Vector.png" style="filter: brightness(0) invert(1);height:1rem;margin:0;margin-right: 5px;"><?php pll_e('คอนโดมิเนียม')?>
																<?php } else if ($cate_parent->slug == 'house') { ?>
																	<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input.png" style="filter: brightness(0) invert(1);height:1rem;margin:0;margin-right: 5px;"><?php pll_e('บ้านและทาวน์โฮม')?>
																<?php } ?>
															</div>
															<div class="flex flex-row items-center" style="line-height: 28px;margin-top: 6px;">
																<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-1.png" style="filter: brightness(0) invert(1);height:1rem;margin:0;margin-right: 5px;"><?= $loca_child->name ?>
															</div>
														</div>
				...
				<div class="s-container px-4">
					<div class="grid grid-cols-2">
						...
						<h5 class="col-span-1 text-right">
							<a href="/news-archive" class="cl-ci-blue-300see-more"><?php pll_e('ดูทั้งหมด')?><img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="m-0 pl-2 inline-block" style="width: auto; height: 24px;">
							</a>
						</h5>
					</div>
					<sp class="h-6 lg:h-12"></sp>
	...
	<?php } else { ?>
		...
		/*#related-post h1{
						...
						<section id="related-post" class="sec-related-post padding-l-vtc bg-ci-blue-300 cl-white">
							<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector-2.png" class="absolute pointer-events-none" style="top: 0; left: 0;opacity: 0.1;">
							<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector-3.png" class="absolute pointer-events-none" style="top: 0; left: 0;opacity: 0.1;">
							...
							<div class="cont-pd">
								<div class="grid grid-cols-3 px-4 lg:px-0">
									...
									<h5 class="col-span-1 text-right">
										<a href="/<?= $p_cate[0]->slug; ?>" class="see-more"><?php pll_e('ดูทั้งหมด')?><img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r.png" class="m-0 pl-2 inline-block" style="width: auto; height: 35px;">
										</a>
									</h5>
