							...
							<div class="grid grid-cols-2">
								...
								<div class="col-span-1 text-right pr-0">
									<a href="/<?=pll_current_language()?>/news" class="see-more flex justify-end pointer cl-ci-blue-300">
										<h5 class="cl-ci-blue-300 f30-28"><?php pll_e('ดูทั้งหมด')?></h5> <img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="inline-block" style="width:35px;margin:0;margin-left: 10px;">
									</a>
								</div>
							</div>
