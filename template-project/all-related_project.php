            ...
            <div class="t-center relative-wrap">
                <div class="grid grid-cols-12">
                    ...
                    <h5 class="col-span-3 text-right">
                        <a href="/project-search/"target="_blank" class="see-more"><?php pll_e('ดูทั้งหมด')?><img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="m-0 pl-2 inline-block" style="width: auto; height: 35px;" >
                        </a>
                    </h5>
                                        ...
                                        <div class="bottom-left">
                                            <div class="flex flex-row items-center" style="line-height: 28px;">
                                                ...
                                                if ($cate_parent->slug == 'condominium') { ?>
                                                    <img src="<?= ASW_MEDIA_PATH ?>/2022/09/Vector.png" style="filter: brightness(0) invert(1);height:1rem;margin:0;margin-right: 5px;">
                                                    <?=$cate_parent->name?>
                                                <?php } else if ($cate_parent->slug == 'house') { ?>
                                                    <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input.png" style="filter: brightness(0) invert(1);height:1rem;margin:0;margin-right: 5px;">
                                                    <?=$cate_parent->name?>
                                                <?php } ?>
                                            </div>
