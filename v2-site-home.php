	...
	<div id="home-slider-inner">
		...
		<div id="home-slider-slides">
			...
			<div id="home-slider-arrow">
				<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-l.png" class="-l"
				onclick="changeSlider(-1);stopAutoplay()">
				<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="-r"
				onclick="changeSlider(1);stopAutoplay()">
			</div>
...
if ($f['is_open']=='open') {
	...
	<div class="bg-yellow-200-" id="desktop_promotion">
		<img src="<?= ASW_MEDIA_PATH ?>/2022/10/เงากิ่งไม้-1.png" class="absolute pointer-events-none leaf01">
		<img src="<?= ASW_MEDIA_PATH ?>/2022/10/leaves-shadow-1.png" class="absolute pointer-events-none leaf03">
		<div class="cont-pd">
			<div id="home-slider-wrap-cont">
				...
				<div>
					...
					<h5 class="see-more cl-white"><a href="/<?=pll_current_language()?>/promotion" class="">
						...
						src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r.png" class="inline-block"
						style="width:30px">
					</a></h5>
					<sp class="xl"></sp>
				</div>
			...
			<box col="9" id="home_promotion_slides_wrap_box">
				<inner class="" id="home_promotion_slides_wrap_inner" data-items="<?= $promo_chk ?>">
					<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="promotion-slide--r --l"
					...
					<div id="home_promotion_slides_wrap">
						...
						<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="promotion-slide--r"
						onclick="show_promo_arrow(1)">
					</div>
				</inner>
			</box>
					...
					<div class="md:ml-12">
						...
						<a href="<?=$f['featured_1']['url']?>" class="text-2xl" target="_blank">
							<h5 class="see-more">
								...
								<img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r.png" class="inline-block"
								style="width:30px">
							</h5>
						</a>
					</div>
				...
				<div class="p-4 md:pl-8 md:pr-8 cl-ci-grey-300" style="font-size: 22px;line-height: 28px;">
					...
					<a href="<?=$f['featured_2']['url']?>" class="" target="_blank">
						<h5 class="see-more cl-ci-blue-300">
							...
							<img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="inline-block"
							style="width:30px">
						</h5>
					</a>
				</div>
		...
		<div class="grid md:grid-cols-12 gap-4">
			...
			<div class="app-btn-wrap">
				<a href="<?=$f['featured_4']['apple_store_url']?>" class="" target="_blank">
					<img src="<?= ASW_MEDIA_PATH ?>/2022/09/google-play-1.png" class="app-btn" style="width: 170px">
				</a>
				<a href="<?=$f['featured_4']['google_play_url']?>" class="" target="_blank">
					<img src="<?= ASW_MEDIA_PATH ?>/2022/09/google-play.png" class="app-btn" style="width: 170px">
				</a>
			</div>
		</div>
	</div>
...
<img src="<?= ASW_MEDIA_PATH ?>/2022/10/shutterstock_1574382076-1.png" class="absolute pointer-events-none leaf06">
<img src="<?= ASW_MEDIA_PATH ?>/2022/11/Group-793-1.png" class="absolute pointer-events-none leaf07">
...
<div class="cont-pd" style="z-index: 3;"> <!-- px-4 md:px-20 -->
	<div class="grid grid-cols-2">
		<div class="col-span-1 flex items-center">
			...
			<h1 class="cl-white" style="z-index: 3;">ข่าวสาร 2</h1>
		</div>
		<div class="col-span-1 text-right pr-0 p-6">
			<a href="/<?=pll_current_language()?>/news" class="see-more flex justify-end pointer cl-ci-blue-300">
				...
				src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="inline-block"
...
<script type="module">
	...
	hammerTime.on("panend", function (ev) {
		...
		if (el.dataset.max == undefined) {
			el.dataset.max = $$('.home-news-cards-wrap > div').length
		}
		let i = el.dataset.i
...
<section id="blog" class="sec-blog">
	<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector-2.png" class="absolute pointer-events-none"
	style="top: 0; left: 0;opacity: 0.1;">
	<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector-3.png" class="absolute pointer-events-none"
	style="top: 0; left: 0;opacity: 0.1;">
	<img src="<?= ASW_MEDIA_PATH ?>/2022/10/เงากิ่งไม้-2.png" class="absolute pointer-events-none leaf08">
	<div class="cont-pd">
		<div class="grid grid-cols-2">
			...
			<div class="col-span-1 cl-white flex items-center justify-end" style="z-index: 2;">
				<a href="/<?=pll_current_language()?>/blog" class="see-more flex justify-end pointer cl-white">
					<h5 class="f30-28"><?php pll_e('ดูทั้งหมด') ?></h5> <img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r.png"
...
<section id="home_filter" class="whitespace-nowrap bg-ci-grey-900 sec-home-filter">
		...
		<div class="lg:flex justify-center grid grid-cols-1 lg:grid-cols-4 lg:gap-2">
			<div class="px-8 col-span-1 home-bottom-filter pointer" data-clickblank onclick="window.location.href='https://aswland.assetwise.co.th';">
				<div class="home-bottom-filter-img">
					<img src="<?= ASW_MEDIA_PATH ?>/2022/10/icon-menu-1.png">
				</div>
			...
			<div class="px-8 col-span-1 home-bottom-filter pointer" data-clickblank onclick="window.location.href='https://procurement.assetwise.co.th';">
				<div class="home-bottom-filter-img">
					<img src="<?= ASW_MEDIA_PATH ?>/2022/10/icon-menu-2.png">
				</div>
	...
	<!-- <div class="px-8 col-span-1 home-bottom-filter pointer" onclick="window.location.href='#';">
		<div class="home-bottom-filter-img">
			<img src="<?= ASW_MEDIA_PATH ?>/2022/10/icon-menu-3.png">
		</div>
		<h6 class="text-center cl-ci-grey-200 f26-22">ร่วมงานกับเรา</h6>
	</div> -->
	<div class="px-8 col-span-1 home-bottom-filter pointer">
		<div class="home-bottom-filter-img">
			<a href="tel:021680000" class=""><img src="<?= ASW_MEDIA_PATH ?>/2022/10/icon-menu-4.png"></a>
		</div>
		<a href="tel:021680000" class=""><h6 class="text-center cl-ci-grey-200 f26-22"><?php pll_e('ติดต่อเรา') ?></h6></a>
	</div>
</div>
</div>
</section>
...
<section id="all_project" class="sec-all-pro padding-l-vtc-">
	<img src="<?= ASW_MEDIA_PATH ?>/2022/11/leaves-shadow-4.png" class="absolute pointer-events-none leaf09">
	<img src="<?= ASW_MEDIA_PATH ?>/2022/11/leaves-shadow2-1.png" class="absolute pointer-events-none leaf10">
		...
		<div id="show-all" style="transition: .5s;opacity: 0;max-height: 0;overflow: hidden;" class="whitespace-nowrap">
			...
			<div id="show-condo">
				<span class="flex flex-row items-center justify-center" style="padding-top: 1rem;padding-bottom: 1rem;">
					<img src="<?= ASW_MEDIA_PATH ?>/2022/09/Vector.png" style="height:24px;margin:0;margin-right: 12px;">
			...
			<div id="show-townhome">
				<span class="flex flex-row items-center justify-center txt-townhome">
					<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input.png"
