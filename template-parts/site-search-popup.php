...
<section id="search-popup-wrap" data-toggle="0">
	<header>
		<div class="-inner">
			<div></div>
			<div><img src="<?= ASW_MEDIA_PATH ?>/2023/05/search.png" class="w-full"></div>
			<div class="full-h">
			...
			<div class="-close" onclick="document.querySelector('#search-popup-wrap').dataset.toggle=0"><img src="<?= ASW_MEDIA_PATH ?>/2023/05/menu.png" class="w-full"></div>
		</div>
	</header>
