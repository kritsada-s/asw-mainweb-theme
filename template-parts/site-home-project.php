...
<section id="project" class="padding-vl-vtc sec-project" data-item="<?=ofsize($p)?>">
	<img src="<?= ASW_MEDIA_PATH ?>/2022/10/เงากิ่งไม้-3.png" class="absolute pointer-events-none leaf02">
	<div class="">
		<div class="absolute w-full top-1/2">
			<div class=" cont-pd">
				<img id="home-pro-arrow-1" src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-l.png" class="absolute pointer  <?php if ($count_pro <= 4) {
					echo '';
				} ?>" onclick="homeProjectArrow(-1)">
				<img id="home-pro-arrow-2" src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="absolute pointer  <?php if ($count_pro <= 4) {
					echo '';
