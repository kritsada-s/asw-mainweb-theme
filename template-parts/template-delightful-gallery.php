...
<style>
    ...
    .gallery-nav-line-bar {
        ...
        position: absolute;
        z-index: 2;
        width: calc(50% / (var(--max)/<?= ceil((ofsize($content['gallery']) / 3) - 2) ?>));
        height: 8px;
    ...
    .gallery-group:nth-child(odd) .gallery-group-items .gallery-group-item[data-i='0'] {
        grid-column: span 6 / span 6;
        grid-row: span 2 / span 2;
    }

    .gallery-group:nth-child(even) .gallery-group-items .gallery-group-item[data-i='2'] {
        grid-column: span 6 / span 6;
        grid-row: span 2 / span 2;
    }
...
<section id="gallery" data-i="0" class="is-on-nav is-on-nav-mob" style="--i: 0;">
