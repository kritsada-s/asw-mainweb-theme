    ...
    <?php foreach ($units as $unit) {?>
      <div class="unit-box border rounded-b-md shadow bg-white">
        <div class="unit-thumbnail relative">
          <div class="absolute bg-orange-500 text-white lg:right-4 right-1 -bottom-4 rounded-full py-1 px-4 leading-none text-center lg:text-[24px] text-[18px] font-medium text-white">
            <?= $unit['highlightText'] ?>
          </div>
