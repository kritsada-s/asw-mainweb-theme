							...
							<div class="">
								...
								<div class="pr-0">
									<a href="<?= $guid ?>" class="see-more pointer text-white hover:text-white text-white flex items-center">
										<h5 class="inline-block"><?php pll_e('อ่านเพิ่มเติม') ?></h5> <img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r.png" class="inline-block" style="width:35px;margin:0;margin-left: 10px;">
									</a>
								</div>
							</div>
						</div>
