            ...
            <div class="col-span-8" id="project-footer-side-2">
                <div class="footer-info">
                    <div class="footer-tel icon-btn">
                        <img src="<?= ASW_MEDIA_PATH ?>/2023/02/Call.png" alt="">
                        <?= $content['telephone_number'] ?>
                    </div>
                    <div class="footer-button">
                        <a href="">
                            <div class="icon-btn">
                                <img src="<?= ASW_MEDIA_PATH ?>/2023/02/Vector.png" alt=""> facebook
                            </div>
                        </a>
                        <a href="">
                            <div class="icon-btn">
                                <img src="<?= ASW_MEDIA_PATH ?>/2023/02/Icon-1.png" alt=""> LINE
                            </div>
                        </a>
                        <a href="">
                            <div class="icon-btn">
                                <img src="<?= ASW_MEDIA_PATH ?>/2023/02/Location-1.png" alt=""> Sale Gallery
                            </div>
                        </a>
                    </div>
                </div>
