	...
	<div class="cont-pd  pt-11 lg:pt-10 -pb-10">
		...
		<div class="grid grid-flow-row lg:grid-cols-12 gap-4">
			...
			<div id="Modal-img" class="modal-img scroll-hid">
				...
				<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-l.png" class="absolute pointer hidden md:block arrow-l" onclick="plusSlides(-1)" style="z-index: 9;">
				<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="absolute pointer hidden md:block arrow-r" onclick="plusSlides(1)" style="z-index: 9;">
			</div>
		</div>
	</div>
</section>
