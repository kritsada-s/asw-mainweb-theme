...
@media (max-width: 767px) {
    ...
    <!-- <section id="thank-you" class="mx-auto pt-10 pb-20 px-4 md:px-0">
        <div class="flex flex-col items-center text-center">
            <img src="<?= ASW_MEDIA_PATH ?>/2023/05/thankyou-contact-us.png" alt="">
            <h2>ขอขอบคุณ</h2>
            <div class="sub-menu">
            ...
            <div class="-info-wrap">
                <a href="tel:<?= $v['telephone'] ?>" class="-info-tel">
                    <img src="<?= ASW_MEDIA_PATH ?>/2023/05/phone-contact-us.png" alt="">
                    <div class="hightlight">
                        <?= $v['telephone'] ?>
                    </div>
                </a>
                <a href="#!" class="-info-more">
                    <img src="<?= ASW_MEDIA_PATH ?>/2023/05/line-contact-us.png" alt="">
                    <div class="hightlight">
                        สอบถามเพิ่มเติม
                    </div>
                </a>
