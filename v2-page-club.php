	...
	<section id="asw-club" class="padding-l-vtc bg-ci-grey-900">
		...
		<div class="cont-pd">
			...
			<div class="lg:col-span-9 overflow-hidden">
				<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="hidden lg:block club-slide--r --l" onclick="show_promo_arrow(-1)">
				<div id="club_slides_wrap">
					...
					<div id="club_slides" class="py-4 mt-0 lg:mt-14">
						...
						while ($loop->have_posts()) : $loop->the_post();
							...
							?>
							<div class="club_slide shadow-md overflow-hidden">
								<a href="<?= get_the_permalink() ?>" class="">
									<div class="grid grid-cols-12 card-img">
										<div class="col-span-12 lg:col-span-5 bg-cover blank wide" ratio="1:1" style="background-image:url('<?= get_the_post_thumbnail_url($post->ID, 'large') ?>'); height: auto;">
										</div>
										<div class="col-span-12 grid grid-rows-7 lg:col-span-7 p-4 lg:p-8 relative card-body" style="background: var(--ci-blue-300);">
											...
											<span id="txt_hilightPost" class="cl-ci-blue-700 " style="font-weight: 400">
												<p class="txt_2line"><?php echo  get_the_excerpt(); ?></p>
											</span>
											<div class="row-span-4"></div>
											<div class="readmore see-more">
												<div class="flex h-full justify-center items-center px-0 lg:px-4">
													<h5 class="hidden lg:block" style="font-weight: 500;">
														อ่านเพิ่มเติม
													</h5>
													<h5 class="block lg:hidden" style="font-weight: 500;">
														ดูทั้งหมด
													</h5>

													<img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="m-0 pl-1 lg:pl-2" style="width: auto; height: 35px;">
												</div>
											</div>
										</div>
									</div>
								...
								<a href="<?= get_the_permalink() ?>" class="">
									<div class="grid grid-cols-12 card-img">
										...
										<div class="col-span-12 grid grid-rows-7 lg:col-span-7 p-4 lg:p-8 relative card-body" style="background: var(--ci-blue-300);">
											...
											<!-- <sp class="block lg:hidden vs"></sp> -->
											<h3 id="txt_20" class="h3 truncate xl:whitespace-normal" style="color: white; font-weight: 400;">
												<?= get_the_title() ?>
											</h3>
											<span id="txt_hilightPost" class="cl-ci-blue-700 " style="font-weight: 400">
												<p class="txt_2line"><?php echo  get_the_excerpt(); ?></p>
			...
			<sp class="l"></sp>
			<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="hidden lg:block club-slide--r" onclick="show_promo_arrow(1)">
		</div>
	</div>
</section>
...
<style type="text/css">
	...
	.side-nav-menu-club .padding{
		padding: 0.5rem 1rem 0.5rem 1rem !important;
		line-height: 32px;
	}
	.side-nav-menu-club .b-select {
		transition: 0.3s;
		border-left: 4px solid var(--ci-orange-500);
		}*/
		.side-nav-menu {}
	...
	<section id="club-info" class="padding-l-vtc">
			...
			<div id="club-info-height" class="grid grid-flow-row lg:grid-cols-12 gap-4">
				<div class="lg:col-span-3">
					...
					<section id="club-menu" class="col-span-3 lg:pl-6 lg:pb-10 pt-4">
						<div class="">
							<div id="club-menu-left">
								<h1 class="">แอสเซทไวส์<br class="hidden lg:block">คลับ</h1>
								<sp class="l"></sp>
								<div id="menu" class="flex flex-row justify-between md:justify-start md:gap-4 lg:flex-col lg:gap-0 side-nav-menu relative pb-2.5 lg:pb-0" style="">
									<!-- 	<div id="menu" class="flex flex-row lg:justify-start lg:flex-col lg:gap-0 side-nav-menu relative pb-2.5 lg:pb-0" style=""> -->
										<div class="hidden lg:block absolute bg-ci-grey-900" style="width: 1px;height: 100%;left: 0px;z-index: 1;">
											<div class="club_vbar"></div>
										</div>
										<div class="block lg:hidden absolute bg-ci-grey-900" style="width: 100%;height: 2.5;bottom: 1.15px;z-index: 1;">
										...
										<h6 onclick="show_info(1)" class=" px-0 lg:px-4 club-menu">
											<span>ข่าวสาร</span>
										</h6>
										<sp class="hidden lg:block" style="height: 1rem;"></sp>
										<h6 onclick="show_info(2)" class=" px-0 lg:px-4 club-menu">
											<span>กิจกรรม</span>
										</h6>
										<sp class="hidden lg:block" style="height: 1rem;"></sp>
										<h6 onclick="show_info(3)" class=" px-0 lg:px-4 club-menu">
					...
					<div class="lg:col-span-9 -overflow-auto -scroll-hid">
						...
						<div id="club-all" class="py-6">
							<h2 class="hidden lg:block">ทั้งหมด</h2>
										...
										<div class="grid grid-rows-12 px-4 py-6">
											<a href="<?= get_the_permalink() ?>" class="">
												...
												<div class="overflow-hidden">
													<div class="bg-cover blank row-span-6" ratio="1:1" style="background-image:url('<?php echo get_the_post_thumbnail_url($post->ID, 'full'); ?>')"></div>
												</div>
												<div class="row-span-5">
													...
													<sp class="vs"></sp>
													<h5 id="txt_header" class=""><?= get_the_title() ?></h5>
													<sp class=""></sp>
				...
				<div id="club-news" class="py-6" style="display: none;">
					<h2 class="hidden lg:block">ข่าวสาร</h2>
					<sp class="l hidden lg:block"></sp>
									...
									<a href="<?= get_the_permalink() ?>" class="">
										<div class="grid grid-rows-12 bg-ci-grey-900 px-4 py-6">
											...
											<div class="row-span-5">
												...
												<span class="tag cl-ci-orange-500">
													<?php
													$txt = $cate_name[0]->slug;
													switch ($txt) {
														case 'club-news':
		...
		<div id="club-activity" class="py-6" style="display: none;">
			<h2 class="hidden lg:block">กิจกรรม</h2>
			<sp class="l hidden lg:block"></sp>
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-7">
				<?php
				$args = array(
...
<div id="club-benefit" class="py-6" style="display: none">
	<h2 class="hidden lg:block">สิทธิประโยชน์</h2>
	<sp class="l hidden lg:block"></sp>
	<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-7">
		<?php
		$args = array(
		...
		while ($loop->have_posts()) : $loop->the_post(); {
			$cate_name = wp_get_post_terms($post->ID, 'club_type');
			$v = get_postdata($post->ID);
			if ($cate_name[0]->slug == "club-benefit") {
				?>
				<div class="col-span-1 ani-club" data-show="0" data-x="null">
					<a href="<?= get_the_permalink() ?>" class="">
						<div class="grid grid-rows-12 bg-ci-grey-900 px-4 py-6">
...
<script type="text/javascript">
	...
	function show_info(num) {
		...
		for (let i = 0; i < allEl.length; i++) {
			// xconsolex.log('index:', i, 'element:', allEl[i].offsetWidth);
			widthElement[i] = allEl[i].offsetWidth;
		}
		// xconsolex.log(allEl)

		for (let i of allEl) {
			// xconsolex.log(i.offsetWidth);
			...
			if (iCount < elNum) {
				...
				barX += i.offsetWidth;
				// barX += widthElement[iCount];

			}
			iCount++

		}
		// xconsolex.log('widthAllElement', widthAllElement);
		...
		if (widthDiv < 768) {
			...
			// gapWidth += (document.querySelector('#club-menu').offsetWidth - widthAllElement) / 5;
			gapWidth += 16;
			barX = barX + (gapWidth * (elNum));
			barXoffset = (document.querySelectorAll('.club-menu')[elNum].offsetWidth) / 2;

			// gapWidth += (widthDiv - (16 * 2)  - widthAllElement)/5;
			// barX = barX+(gapWidth*(elNum+1)); 

			// barXoffset = (document.querySelectorAll('.club-menu')[elNum].offsetWidth)/2;
			// xconsolex.log('widthDiv >= 768 || widthDivh < 1024', widthDiv);
	...
	function show_promo_arrow(plus) {
		...
		if (nowNum < 1) {
			...
			nowNum = max - 1;
			// xconsolex.log('max', document.querySelector("#club_slides_wrap::after".style));	
		} else if (nowNum >= 1) {
		...
		// 	x = max
		// }
		// club_slides_num_now.innerText = pad(x,2)
		show_promo(nowNum)
