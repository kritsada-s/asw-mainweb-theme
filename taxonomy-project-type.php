...
<div id="home-slider-arrow">
    <img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-l.png" class="-l" onclick="changeSlider(-1);stopAutoplay()">
    <img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="-r" onclick="changeSlider(1);stopAutoplay()">
</div>
...
<section id="title" class="pt-4 pb-10 md:pb-14 relative">
  ...
  <img src="<?= ASW_MEDIA_PATH ?>/2022/11/leaves-shadow-1-2.png" class="absolute pointer-events-none leaf13">
  <img src="<?= ASW_MEDIA_PATH ?>/2022/11/shutterstock_1574382076-1-2.png" class="absolute hidden md:block pointer-events-none leaf12">
  <div class="cont-pd">
...
<div style="overflow: visible;">
    <section id="condo-filter" class="pt-16 pb-6" style="background: linear-gradient(180deg, #EDF2F7 -4.71%, #FFFFFF 164.99%);">
        <h1 class="flex justify-center f40-30 cl-ci-grey-200" style="white-space: nowrap;">
            <?php 
            if ($name1 == 'house') {
                pll_e('ค้นหาโครงการบ้านและทาวน์โฮม');
            }else{
                pll_e('ค้นหาโครงการคอนโดมิเนียม');
            }
            ?>
        </h1>
        <sp class="xl"></sp>
                    ...
                    <theboxes class="middle center t-center- -clip round" style="margin-top: 10px;z-index: 10;border-radius: 8px;">
                        <box col="2.5"><inner id="filter_0" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(1, this)">
                            <div class="quick-filter-inner cursor-pointer">
                                <span class="wide">
                                    <div class="grid grid-cols-5">
                                        <div class="col-span-1 flex items-center">
                                            <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-1.png" class="inline-block" style="height:2rem">
                                        </div>
                                ...
                                <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector.png" class="quick-filter-arrow" style="height:.5rem">
                            </div>
                        </inner></box>
                        <box col="2.5" style="display: none;"><inner id="filter_1" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(2, this)" >
                            <div class="quick-filter-inner cursor-pointer">
                                <span class="wide">
                                    <div class="grid grid-cols-5">
                                        <div class="col-span-1 flex items-center">
                                            <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-2.png" class="inline-block" style="height:2rem">
                                        </div>
                                        <div class="col-span-4">
                        ...
                        <box col="2.5"><inner id="filter_2" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(3, this);filter_pop_price(this)" data-price-min="<?=$pro_price_min?>" data-price-max="<?=$pro_price_max?>">
                            <div class="quick-filter-inner cursor-pointer">
                                <span class="wide">
                                    <div class="grid grid-cols-5">
                                        <div class="col-span-1 flex items-center">
                                            <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-3.png" class="inline-block" style="height:2rem">
                                        </div>
                                        <div class="col-span-4">
                        ...
                        <box col="2.5"><inner id="filter_3" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(0, this)">
                            <div class="quick-filter-inner cursor-pointer">
                                <span class="wide">
                                    <div class="grid grid-cols-5">
                                        <div class="col-span-1 flex items-center">
                                            <img src="<?= ASW_MEDIA_PATH ?>/2022/11/Group-908.png" style="height:2rem">
                                        </div>
                                        <div class="col-span-4">
        ...
        <div id="filter_project" class="quick-filter-toggle-3">
            <div class="bg-white round" style="padding:48px 32px;padding-top: 30px;">
                <span class="cl-ci-blue-300" style="font-size: 26px;">
                    <?php 
                    if ($name1 == 'house') {
                        pll_e('บ้านและทาวน์โฮม');
                    }else{
                        pll_e('คอนโดมิเนียม');
                    }
                    ?>
...
<section id="filter-head"class="">
    <h3 style="font-weight: 400;font-size: 30px;line-height: 36px;text-align: center" >
       <?php 
       if ($name1 == 'house') {
        pll_e('ค้นหาโครงการบ้านและทาวน์โฮม');
    }else{
                    ...
                    <div class="filter-inner-mini pointer bg-white" onclick="openPopFilter()">
                        ...
                        <span class="wide">
                            <div class="grid grid-cols-5 gap-0 flex items-center">
                                <div class="col-span-1 flex items-center">
                                    <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input.png" class="inline-block" style="height:2.5rem;margin:0;">
                                </div>
                                <div class="col-span-4">
                        ...
                        <img src="<?= ASW_MEDIA_PATH ?>/2022/11/arrow.png" style="height: 15px;">
                    </div>  
                </div>
            </div>
        </div>
            ...
            <div class="hidescroll flex flex-row overflow-y-scroll md:overflow-y-hidden md:grid md:grid-cols-6 md:gap-2">
                ...
                <div class="col-span-1 flex justify-end mx-4 md:mx-0 items-start">
                    <div class="clear-all inline-flex items-center pointer" onclick="remove_price();filter_pop(999, this);check_chk('clear', 999)" style="white-space: nowrap;">
                        <img src="<?= ASW_MEDIA_PATH ?>/2022/11/Vector-10.png" style="width: 21px;height: 21px;">&ensp;<?php pll_e('ล้างทั้งหมด')?>
                    </div>
                </div>
            </div>
        </div>
...
<div class="mini-filter-popup">
    ...
    <h3 style="color: #374151;font-size: 30px;line-height: 36px;font-weight: 400;margin-top: 27.5px;">
     <?php 
     if ($name1 == 'house') {
        pll_e('ค้นหาบ้านและทาวน์โฮมในแบบคุณ');
    }else{
        pll_e('ค้นหาคอนโดมิเนียมในแบบคุณ');
    }
    ?>
</h3>
...
<div class="popup-filter-inner" onclick="filter_pop_mini(0)">
    <div class="grid grid-cols-12">
        <div class="col-span-1 flex items-center">
            <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-1.png" class="inline-block" style="height:2rem;margin:0;">
        </div>
        ...
        <div class="col-span-1 flex items-center">
            <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector.png" class="quick-filter-arrow-mini">
        </div>
    </div>
</div>
<sp class="sp-mini"></sp>
...
<div id="filter_brand_mini" class="mini-filter-toggle-2">
    <div class="bg-white">
        <span class="pl-3 cl-ci-blue-300" style="font-size: 26px;">
           <?php 
           if ($name1 == 'house') {
            pll_e('บ้านและทาวน์โฮม');
        }else{
...
<div class="popup-filter-inner" onclick="filter_pop_mini(2)">
    <div class="grid grid-cols-12">
        <div class="col-span-1 flex items-center">
            <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-3.png" class="inline-block" style="height:2rem;margin:0;">
        </div>
        <div class="col-span-10 pl-3">
...
<div class="popup-filter-inner" onclick="filter_pop_mini(3)">
    <div class="grid grid-cols-12">
        <div class="col-span-1 flex items-center">
            <img src="<?= ASW_MEDIA_PATH ?>/2022/11/Group-908.png" class="inline-block" style="height:2rem;margin:0;">
        </div>
        <div class="col-span-10 pl-3">
    ...
    function check_chk(ele, num){
        ...
        if(txtt_loca.length != 0) {
            for (var i = 0; i < txtt_loca.length ; i++) {
                ...
                <img src="<?= ASW_MEDIA_PATH ?>/2023/01/x-1.png" class="pointer" style="margin-bottom:0;margin-left:0.5rem;width:16px;height:16px;" >
                </div>
                `
            }
            clearAll += text_loca;
...
<style type="text/css">
    ...
    .project-card[data-wp-post-status="draft"] {
        opacity: .3;
    }
</style>
<script type="text/javascript">
...
<section id="condo-show" class="pt-8 pb-20 md:pb-16 relative" style="background: linear-gradient(180deg, #EDF2F7 -4.71%, #FFFFFF 164.99%); z-index: 10;">
    <img src="<?= ASW_MEDIA_PATH ?>/2022/11/shutterstock_1574382076-1-2.png" class="absolute pointer-events-none leaf14">
    <div class="cont-pd">
        <?php
        $qry_post_status = ['publish'];
        if (current_user_can( 'administrator' ) && get_current_user_id() == 22) {
            $qry_post_status = ['publish','draft'];
        }
        $args = array(
            'post_type' => ['condominium','house'],
            'post_status' => $qry_post_status,
            'posts_per_page' => 100, 
            'orderby' => 'date', 
            'order' => 'DESC',
            'post_parent' => 0,
        ...
        <div class="grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 flex items-center">
            <div class="row-span-1 md:col-span-1">
                <h5 class="f30-28 cl-ci-grey-100">
                   <?php 
                   if ($name1 == 'house') {
                    pll_e('บ้านและทาวน์โฮมทั้งหมด');
                }else{
                    pll_e('คอนโดมิเนียมทั้งหมด');
                }
        ...
        <div class="row-span-1 md:col-span-1 flex justify-end">
            <div  id="sortby-box-wrap" class="box-fil-date pointer relative" data-sortby="-1" data-sorttype="date" onclick="turnon_sorting()">
                ...
                <span class="sortby-box" data-sortby="1" data-sorttype="date">
                    <?php pll_e('เรียงตามโครงการเก่า')?> <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector.png" style="height: .3rem;transform:rotate(-90deg);display: inline-block;"> <?php pll_e('ใหม่')?>
                </span>
                <span class="sortby-box" data-sortby="1" data-sorttype="price">
                    <?php pll_e('เรียงตามราคาเริ่มต้นสูง')?> <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector.png" style="height: .3rem;transform:rotate(-90deg);display: inline-block;"> <?php pll_e('ต่ำ')?>
                </span>
                <span class="sortby-box" data-sortby="-1" data-sorttype="price">
                    <?php pll_e('เรียงตามราคาเริ่มต้นต่ำ')?> <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector.png" style="height: .3rem;transform:rotate(-90deg);display: inline-block;"> <?php pll_e('สูง')?>
                </span>
                <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector.png" class="-arrow">
                <div class="-choise">
                        <!-- <div class="-choise-1" onclick="sorting_project(-1)">
                            เรียงตามโครงการใหม่ <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector.png" style="height: .3rem;transform:rotate(-90deg);display: inline-block;"> เก่า
                        </div>

                        <div class="-choise-2" onclick="sorting_project(1)">
                            เรียงตามโครงการเก่า <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Vector.png" style="height: .3rem;transform:rotate(-90deg);display: inline-block;"> ใหม่
                        </div> -->
        ...
        <div id="condo-info" class="whitespace-nowrap grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8" data-sortby="-1" >
            ...
            while ( $loop->have_posts() ) : $loop->the_post(); {
                ...
                ?>
                <div data-compare-id="<?=$post->ID?>" data-wp-post-status="<?=$post->post_status?>" data-compare-selected="0" the="<?=$cate_parent->name?>" cate="<?=$cate_brand->name?>" data-price="<?=$pj_price?>" data-date="<?=$order?>" loca="<?=$loca_child->name?>" type="<?=$stat_label?>" class="home-project-card col-span-1 project-card card-img" style="--i:<?=$order?>;order:calc( var(--i) * var(--sortby) * -1);display: grid;">
                        ...
                        <div data-compare-id="<?=$post->ID?>" class="card-project relative pointer grid grid-cols-2 md:block" data-show="0" data-x="null">
                            ...
                            <div class="bottom-left project-card-info-1">
                                ...
                                <div class="flex flex-row items-center" class="f22-20" style="margin-top: 6px;">
                                    <img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-1.png" class="project-card-icon -loca"><?=$loca_child->name?>
                                </div>
                            </div>
        ...
        <div id="notfound" class="flex flex-col justify-center items-center hidden">
            <sp class="rem-5"></sp>
            <img src="<?= ASW_MEDIA_PATH ?>/2022/12/Group-937.png" style="margin-bottom: 30px;">
