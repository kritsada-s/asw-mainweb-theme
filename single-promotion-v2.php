		...
		<section id="related-project" style="background-image: linear-gradient(white, #EDF2F6);padding-top: 95px;padding-bottom: 106px;">
			...
			if($v['participating-projects']){ 
				...
				<div class="s-container">
					<div>
						<img class="promo-leaf01" src="<?= ASW_MEDIA_PATH ?>/2022/11/shutterstock_1574382076-1.png">
					</div>
			...
			// pre($v['project_description']);
					...
					<div >
						<img class="promo-leaf01" src="<?= ASW_MEDIA_PATH ?>/2022/11/shutterstock_1574382076-1.png">
						<img class="promo-leaf02" src="<?= ASW_MEDIA_PATH ?>/2022/11/Group-793.png">
					</div>
							...
							<div class="col-span-1 md:col-span-6 xl:col-span-5 px-4 pl-6 xl:pt-10" style="z-index: 1;">
								...
								<h5 class="">
									<a href="<?= $v['project'][0]->guid ?>" class=""><?php pll_e('อ่านเพิ่มเติม')?>
										<img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="m-0 pl-2 inline-block" style="width: auto; height: 35px;">
									</a>
								</h5>
	...
	<div class="relative">
		<div class="grid grid-cols-12">
			<div class="col-span-12 md:col-span-12 lg:col-span-7 pt-20 pb-24 s-container">
				<!-- <img src="<?= ASW_MEDIA_PATH ?>/2022/12/w-bg.png" class="absolute" style="top: 0; left: 0;opacity: 0.1;"> -->
			...
			<div class="grid grid-cols-5">
				...
				<h5 class="col-span-2 text-right pt-3">
					<a href="/promotion" class=""><?php pll_e('ดูทั้งหมด')?>
						<img src="<?= ASW_MEDIA_PATH ?>/2022/09/arrow-r-main.png" class="m-0 pl-2 inline-block" style="width: auto; height: 35px;"></a>
					</h5>
				</div>
