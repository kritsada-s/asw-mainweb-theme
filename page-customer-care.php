...
<section id="contact-pdpa">
    ...
    <div class="lg:container mx-auto pt-0 lg:pt-10 px-4">
        <div class="grid grid-flow-row lg:grid-cols-12 gap-4 xl:px-0 lg:gap-8">
            <div class="lg:col-span-4">
                <!--=== The Section Boxes : contact-menu ===-->
                <section id="contact-menu" class="lg:pl-3 lg:pb-10 pt-4 xl:px-0">
                    ...
                    <div class="contact-menu px-0 lg:px-4 cl-ci-orange-500 font-medium">
                        <a href="/<?=pll_current_language()?>/customer-care" class=""><img src="<?= ASW_MEDIA_PATH ?>/2023/04/Vector-17.png"
                            alt=""> AssetWise Customer Care</a>
                        </div>
                        <sp class="hidden lg:block" style="height: 1rem;"></sp>

                        <div class="contact-menu px-0 lg:px-4">
                            <a href="/<?=pll_current_language()?>/appeal-form" class=""><img src="<?= ASW_MEDIA_PATH ?>/2023/04/Vector-18.png" alt="">
                        ...
                        <div class="contact-menu px-0 lg:px-4">
                            <a href="/<?=pll_current_language()?>/contact-pdpa-officer" class=""><img
                                src="<?= ASW_MEDIA_PATH ?>/2023/04/Vector-19.png" alt="">
                        ...
                        <div class="contact-menu px-0 lg:px-4">
                             <a target="_blank" href="https://services.assetwise.co.th/DSRM/DSRForm" class=""><img
                                src="<?= ASW_MEDIA_PATH ?>/2023/04/Vector-20.png" alt=""> <?php pll_e('พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล')?></a>
                        </div>
                        <sp class="hidden lg:block" style="height: 1rem;"></sp>
                    ...
                    <div class="block lg:hidden absolute bg-ci-grey-900 contact_hline"
                    style="height: 2.5px;bottom: 1.15px;z-index: 1;">
                    <div class="contact_hbar" style="width: 286px;"></div>
                </div>
            </div>
        </section>
    </div>
    <div id="contact-form" class="lg:col-span-8 pt-8 md:pt-0 xl:pt-4">
        <div class="-wrap">
            <div class="-title-wrap">
                <h2 class="-title">AssetWise Customer Care</h2>
            </div>
            <div class="-body">
                <style>
                ...
                <?= apply_shortcodes('[contact-form-7 id="8620" title="Customer Care"]'); ?>
                <div class="-checkbox">
                    <label onchange="check_customercare()">
                        ...
                        <span> <?php pll_e('บริษัทฯ จะจัดเก็บข้อมูลของท่าน เพื่อเจ้าหน้าที่ของเราจะรับเรื่องและติดต่อกลับ เพื่อให้ข้อมูลเพิ่มเติม โดยเร็วที่สุดคลิกที่นี่เพื่อดู')?>
                            <a href=""><?php pll_e('นโยบายความเป็นส่วนตัว')?></a>
                            และ
                            <a href=""><?php pll_e('ข้อกำหนดและเงื่อนไข')?></a>
                        </span>
                    </label>
            ...
            <script>
                function send_customercare() {
                    ...
                    $('#asw_customercare-submit').click()
                }

                function check_customercare() {
                    $('#asw_customercare-check input').click()
                }
            </script>
        </div>
    </div>
