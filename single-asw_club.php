		...
		<section id="gallery" class="padding-xl-vtc">
			...
			<div id="Modal-img" class="modal-img scroll-hid" style="z-index: 10000;">
					...
					<div class="s-container grid grid-cols-12 gap-4 ">
						...
						<div class="col-span-3 lg:col-span-1">
							<div class="modal-nav-img">
								<img src="<?= ASW_MEDIA_PATH ?>/2022/11/download_icon.png" class="pointer">
								<img src="<?= ASW_MEDIA_PATH ?>/2022/11/exit_icon.png" onclick="closeModal()" class="pointer">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal-img-content">
					...
					<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-l.png" class="prev hidden md:block" onclick="plusSlides(-1)">
					<img src="<?= ASW_MEDIA_PATH ?>/2022/09/slide-arrow-r.png" class="next hidden md:block" onclick="plusSlides(1)">
