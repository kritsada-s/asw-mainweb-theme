...
<?php 
$f = get_fields();
$s_type_title = pll__('บ้านและทาวน์โฮม');
$s_type_url = 'house';
...
<div class="cont-pd py-6 flex flex-row items-center">
	...
	<a href="/<?=pll_current_language()?>/<?=$s_type_url?>" class=""><?=$s_type_title?></a>
</div>
<sp class=""></sp>
...
<!--=== The Section Boxes : condo-type ===-->
<section id="condo-type" class="padding-l-vtc relative">
	<img src="<?= ASW_MEDIA_PATH ?>/2022/11/leaves-shadow-1-2.png" class="absolute pointer-events-none leaf11">
	<img src="<?= ASW_MEDIA_PATH ?>/2022/11/shutterstock_1574382076-1-2.png" class="absolute pointer-events-none leaf12">
	<div class="cont-pd t-center">
			...
			<div class="cont-pd">
				<div class="">
					<theboxes class="middle center t-center- -clip round" style="margin-top: 10px;z-index: 10;border-radius: 8px;">
						...
						<box col="2.5"><inner id="filter_1" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(2, this)">
							<div class="quick-filter-inner cursor-pointer">
								<span class="wide">
									<div class="grid grid-cols-5">
										<div class="col-span-1 flex items-center">
						...
						<box col="2.5"><inner id="filter_2" class="padding quick-filter v-middle-wrap pointer" onclick="filter_pop(3, this);filter_pop_price(this)">
							<div class="quick-filter-inner cursor-pointer">
								<span class="wide">
									<div class="grid grid-cols-5">
										<div class="col-span-1 flex items-center">
...
<section id="filter-head"class="">
	<h3 style="font-weight: 400;font-size: 30px;line-height: 36px;text-align: center" ><?php pll_e('ค้นหาโครงการบ้านและทาวน์โฮม')?></h3>
</section>
...
<div class="mini-filter-popup">
	...
	<h3 style="color: #374151;font-size: 30px;line-height: 36px;font-weight: 400;margin-top: 27.5px;"><?php pll_e('ค้นหาโครงการบ้านและทาวน์โฮมในแบบคุณ')?></h3>
...
<div class="popup-filter-inner" onclick="filter_pop_mini(1)">
	<div class="grid grid-cols-12">
		<div class="col-span-1 flex items-center">
			<img src="<?= ASW_MEDIA_PATH ?>/2022/10/Icon-in-input-2.png" class="inline-block" style="height:2rem;margin:0;">
		</div>
		<div class="col-span-10 pl-3">
...
<script type="text/javascript">
	...
	function check_chk(ele, num){
		...
		var refresh = window.location.protocol + "//" + window.location.host + window.location.pathname + "?type=" +id_type + "&location=" + id_loca + "&brand=" +id_brand + "&price_min=" + last_min + "&price_max=" + last_max;
	...
	<div class="cont-pd">
		...
		<div class="grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 flex items-center">
			<div class="row-span-1 md:col-span-1">
				<h5 class="f30-28 cl-ci-grey-100"><?php pll_e('บ้านและทาวน์โฮมทั้งหมด')?> <span id="num-con" class="cl-ci-grey-400">- <?=$count_num['condominium']?> <?php pll_e('รายการ')?></span></h5>
			</div>
