...
<div class="pl-10 pt-8 flex flex-row items-center">
	...
	<img src="<?= ASW_MEDIA_PATH ?>/2023/01/Vector-84.png" style="margin:0px 12px;">
			...
			<div id="about-asw" class="lg:col-span-9">
				<div class="cont-pd">
					<div class="flex flex-col justify-center">
						...
						<sp class="vl"></sp>
						<div class="">
							<iframe width="800" height="430" src="https://www.youtube.com/embed/ht0iF87FMdI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						<sp style="height: 40px;"></sp>
						<div class="px-0 sm:px-12 lg:px-20 cl-ci-grey-300">
							<?php echo $f['description'] ?>
						</div>
						<img src="https://dev.assetwise.co.th/wp-content/uploads/2025/01/20th-logo.webp" class="mx-auto w-2/5">
					...
					<div class="video-container">
						<iframe width="800" height="430" src="https://www.youtube.com/embed/XzUi_wSbWDY?si=t7vvUWEsE02rvOF2" title="บรรยากาศเบื้องหลังการถ่ายทำภาพยนตร์โฆษณาชุด 20 Years of Happiness" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
					<sp class="rem-1"></sp>
					<div class="px-0 sm:px-12 lg:px-24 cl-ci-grey-300 text-[20px] font-light">
						<?= pll__('ชมภาพบรรยากาศเบื้องหลังการถ่ายทำภาพยนตร์โฆษณาชุด 20 Years of Happiness ที่มี “คุณโต๋- ศักดิ์สิทธิ์ เวชสุภาพร” <br>และภรรยาคนสวย “คุณไบรท์ - พิชญทัฬห์ จันทร์พุฒิ” ควงคู่กันมาเล่าความสุขในโอกาสครบรอบ 20 ปี แอสเซทไวส์') ?>
					</div>
					<sp class="rem-2"></sp>
					<!-- Video -->
				</div>
...
<script type="text/javascript">
	...
	function show_info(num){
		...
		barYoffset = (document.querySelectorAll('.about-menu')[elNum].offsetHeight - 28) / 3;				
